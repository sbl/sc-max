...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "this waits after one \"phase\" has finished. So very low freq values might seem broken.",
					"linecount" : 3,
					"patching_rect" : [ 65.0, 103.0, 165.0, 43.0 ],
					"id" : "obj-14",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Step Noise\n\nGenerates random values at a given rate.",
					"linecount" : 3,
					"patching_rect" : [ 9.0, 44.0, 221.0, 43.0 ],
					"id" : "obj-6",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sc.lfnoise0~ 10",
					"patching_rect" : [ 9.0, 152.0, 88.0, 19.0 ],
					"id" : "obj-3",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "*~ 0.2",
					"patching_rect" : [ 9.0, 336.0, 45.0, 19.0 ],
					"id" : "obj-2",
					"fontname" : "Verdana",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 18.5, 177.0, 54.0, 177.0, 97.0, 224.0, 124.0, 243.0, 147.0, 243.0, 166.0, 243.0, 185.0, 259.0, 118.0, 316.0, 112.0, 316.0, 105.0, 332.0, 126.0, 332.0, 149.0, 332.0, 168.0, 313.0, 181.0, 287.0, 219.0, 260.0, 230.0, 260.0, 230.0, 284.0 ]
				}
